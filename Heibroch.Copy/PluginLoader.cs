...
namespace Heibroch.Copy
{
    ...
    public class PluginLoader : IPluginLoader
    {
        ...
        public void Load()
        {
            ...
            EventLog.WriteEntry("Heibroch.Copy - Initializing", $"Listing plugin directories...\r\nPath: {path}", EventLogEntryType.Information);
            ...
            foreach (var pluginDirectory in pluginDirectories)
            {
                try
                {
                    ...
                    foreach (var assembly in pluginDirectoryAssemblies)
                    {
                        ...
                        //if (assemblyFile.Contains("Heibroch.Copy.Plugin.dll")) continue;
                ...
                {
                    EventLog.WriteEntry("Heibroch.Copy - Initializing", $"Initializing plugin failed...\r\n \r\n {ex.StackTrace}", EventLogEntryType.Error);
